...
[Migration("20250727145620_Update_Proposal_Add_UpdatedAt")]
partial class Update_Proposal_Add_UpdatedAt
{
    /// <inheritdoc />
        ...
        modelBuilder.Entity("ProposalService.Domain.Entities.Proposal", b =>
            {
                ...
                b.HasIndex("IdClient")
                    .HasDatabaseName("ix_proposals_id_client");
        ...
        modelBuilder.Entity("ProposalService.Domain.Entities.Proposal", b =>
            {
                b.HasOne("ProposalService.Domain.Entities.Client", "Client")
                    ...
                    .IsRequired()
                    .HasConstraintName("fk_proposals_clients_id_client");
